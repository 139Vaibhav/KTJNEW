    ...
    <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
        ...
        <div class="mb-2 border-solid border-grey-light rounded border shadow-sm w-full md:w-1/2 lg:w-1/2">
            ...
            <div class="p-3">
                ...
                <a class="bg-transparent hover:bg-blue text-blue-dark font-semibold hover:text-white py-2 px-4 border border-blue hover:border-transparent rounded mr-5" href="<?= base_url() ?>index.php/admin/team">
                    Back
                </a>
